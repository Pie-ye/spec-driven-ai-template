...
- [x] GitHub Actions on the PR branch completed (`verify` run 29194738112).
- [ ] Independent reviewer verdict is `READY_TO_MERGE`; the user explicitly authorized merge without a separate reviewer verdict.
